...
const Login = () => {
  ...
  return (
    <div className="login-container bg-[#06101c] ">
      <div className="bg-[rgba(8,13,22,0.3)] w-[28%] p-[1rem] pr-[1.5rem] rounded-lg outline outline-[1px] outline-[#303030] shadow-[0_8px_20px_rgba(0,0,0,0.5),0_1rem_150rem_rgba(4,19,36,255)]">
        {/* Logo or Header */}
        <div className="">
          ...
          <form onSubmit={submitHandler}>
            ...
            <div className="mb-[1rem]">
              ...
              <a
                ...
                className="forgot-password-link text-[#E3E3E3] underline-animation"
              >
            ...
            <button type="submit" className="submit-btn rounded-lg">
              Sign in
            </button>
        ...
        <div className="social-buttons">
          <button
            className="google-btn rounded-xl"
          ...
          {/* <button
            className="facebook-btn rounded-xl"
